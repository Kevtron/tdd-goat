...
class NewVisitorTest(LiveServerTestCase):
    ...
    def check_for_row_in_list_table(self, row_text):
        '''
        Checks for the existence of a string in the list table
        Args: self, row_text (string
        '''
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        #We can check out a to-do list at a url
        self.browser.get(self.live_server_url)

        # page title shows it's a to-do list
        ...
        # We use a new browser session to make sure that no information of ediths
        # comes through from cookies etc
        self.browser.quit()
        self.browser = webdriver.Firefox()
